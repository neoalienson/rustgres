...
#[test]
fn test_join_with_filter_integration() {
    use rustgres::executor::{SimpleExecutor, SimpleTuple as SimpleTuple, Join, JoinType};
    use rustgres::executor::MockExecutor;
...
#[test]
fn test_intersect_integration() {
    use rustgres::executor::{SimpleExecutor, SimpleTuple as SimpleTuple, Intersect};
    use rustgres::executor::MockExecutor;
...
#[test]
fn test_except_integration() {
    use rustgres::executor::{SimpleExecutor, SimpleTuple as SimpleTuple, Except};
    use rustgres::executor::MockExecutor;
